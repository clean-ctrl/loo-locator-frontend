...
window.BIGFISH_INSTAGRAM = [
  { image: "images/insta-1.jpg", alt: "Fish fleece on a misty dock morning", colors: ["#1f4f4f", "#e8735a"] },
  { image: "images/insta-2.jpg", alt: "Beach fire in a Big Fish fleece", colors: ["#e8735a", "#123236"] },
  { image: "images/insta-3.jpg", alt: "Close-up of the fish print", colors: ["#f1e6d2", "#c98a2b"] },
  { image: "images/insta-4.jpg", alt: "Creek restoration day with Peninsula Streams", colors: ["#3d6b4f", "#dfeee7"] },
  { image: "images/insta-5.jpg", alt: "Kids fleece at the tide pools", colors: ["#6aa5b8", "#fbf8f2"] },
  { image: "images/insta-6.jpg", alt: "Rockfish fleece on the ferry deck", colors: ["#15283d", "#e0664d"] },
];
